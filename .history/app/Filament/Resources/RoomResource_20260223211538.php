        ...
        return [
            Forms\Components\Grid::make(2)->schema([
                ...
                Forms\Components\Select::make('status')
                    ...
                    ->afterStateUpdated(function ($state, Set $set) {
                        // If user changes away from Occupied, clear tenant form fields
                        if ($state !== 'Occupied') {
                            ...
                            // default tenant status when occupied
                            $set('tenant_status', $set('tenant_status') ?? 'Active');
                        }
                    }),
            ]),
            ...
            Forms\Components\Section::make('Tenant Information')
                ...
                ->schema([
                    ...
                    Forms\Components\TextInput::make('tenant_payment_term')
                        ->label('Payment Term')
