    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('full_name')->sortable(), // ✅ remove searchable()

                Tables\Columns\TextColumn::make('phone_number')->label('Phone')->toggleable(),

                // ✅ better: use relationship already loaded
                ...
                Tables\Columns\BadgeColumn::make('status')
                    ...
                    ->sortable(),
                Tables\Columns\TextColumn::make('car_count')->sortable(),
                Tables\Columns\TextColumn::make('motorbike_count')->sortable(),
