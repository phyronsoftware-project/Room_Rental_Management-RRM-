    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                    ...
                    ->query(function (Builder $query, array $data): Builder {
                        ...
                        return $query->when($value, function (Builder $q) use ($value) {
                            $q->where(function (Builder $qq) use ($value) {
                                $qq->where('property_id', 'like', "%{$value}%")
                ...
                // ✅ Optional: Filter មានរូប / គ្មានរូប
                SelectFilter::make('has_image')
                    ...
                    ->query(function (Builder $query, array $data): Builder {
                        ...
                        return $query->when($v !== null, function (Builder $q) use ($v) {
                            if ((string) $v === '1') {
            ...
            ->filtersLayout(FiltersLayout::AboveContent) // ✅ show filters above table
            ->filtersFormColumns(3) // ✅ search + image filter នៅជួរតែមួយ (កែ 2/3/4 តាមចង់)
            ->bulkActions([
